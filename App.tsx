    ...
    <>
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center">
            <img alt="Meu Luuk" className="h-[80px]" src="/img/Grey Neutral Centric Italy Travel Video.png" />
          </div>
      ...
      <section className="py-16 md:py-28 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-7xl lg:text-9xl font-extrabold text-wine dark:text-white leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a className="bg-primary text-wine font-black text-2xl px-10 py-5 rounded-2xl flex items-center justify-center gap-2 hover:shadow-xl hover:shadow-primary/20 transition-all" href="#">
                Começar Agora
      ...
      <section className="bg-wine py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-4xl font-bold text-peach-light leading-snug">
      ...
      <section className="bg-vibrant-orange py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white order-1 lg:order-2 space-y-6">
            ...
            <div className="pt-6">
              <a className="inline-block bg-primary text-wine font-black text-2xl px-12 py-5 rounded-2xl hover:bg-white transition-all shadow-xl" href="#">
      ...
      <section className="bg-lilac py-24 px-6" id="how-it-works">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-[40px] shadow-lg flex flex-col gap-6 transform hover:-translate-y-2 transition-transform">
              <img alt="App screen" className="w-full min-h-[500px] object-cover rounded-3xl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-B8VqjjEoitPDiZ2cc192z0EfgLRycoofgU7GijWVYM-6AfoRIYXhycjae-A2OaeZzGQYPkwq9fLJSMRHD4ncKoYModRX05gK_hZsJZzyOBdl0xmeVNNxW1RwDFdKRDfRqrpGDvPh2KwNcFB4lRNHKAhpy_uMgV2k5sVAWiPmN03xQQKW3FEwTiLQ1ORt85z7jJ0aNlBvsTMbZsvCHmfFBDNNY9oyFAypWZ3dv_ZGFKccYtU0Uv00tVeYKWsD6t3tbJoJKyzYrxo" />
              <div>
                <h3 className="text-2xl font-black text-wine mb-4">Se vista rapidamente</h3>
                <p className="text-gray-700 leading-relaxed">Visualize todo seu armário em segundos. Com o Manual do armário digital você vai saber como cadastrar suas peças, tirar fotos, montar looks, etc.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-[40px] shadow-lg flex flex-col gap-6 transform hover:-translate-y-2 transition-transform">
              <img alt="App screen" className="w-full min-h-[500px] object-cover rounded-3xl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBvm7-tQUxVLYxKPLmmNcJYB8rjRSF7s__-bFFETDc6_mfdO5FPXx-Dg063PzMnkdA7IU4yhSHTlCv5oRXs-BHxU2QcfbCdZenyGmslGnuK-7kpXDFbL4LNivOHvq5RCrqF90IqxJr59iEdgDXA4w6X9wwzAonS7I5_Wx-zF07MCHYMKAbDcWu7F14PJKuZYyvn2ZWUTWPeFuJwZum8-ziMuE3G1njpsIxlDeMmon1co-RM0TNjZNnR8uyWAcqb3JJIilDxUdTtNos" />
              <div>
                <h3 className="text-2xl font-black text-wine mb-4">Organize e Visualize</h3>
                <p className="text-gray-700 leading-relaxed">Seu guarda-roupa do seu jeito. Veja tudo o que tem na sua mão. Pesquise, filtre, como quiser, onde quer que esteja. Planeje looks sem bagunçar nada.</p>
              </div>
            </div>
            <div className="bg-white p-8 rounded-[40px] shadow-lg flex flex-col gap-6 transform hover:-translate-y-2 transition-transform">
              <img alt="App screen" className="w-full min-h-[500px] object-cover rounded-3xl" src="/img/7.png" />
              <div>
                <h3 className="text-2xl font-black text-wine mb-4">Digitalização e Combinações</h3>
                <p className="text-gray-700 leading-relaxed">Organize seu armário rapidamente. Tire fotos de suas roupas, digitalizamos o seu armário combinando as peças, gerando diversas combinações. Saiba exatamente o que já tem antes de comprar.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative bg-white dark:bg-zinc-800 rounded-[3rem] border-8 border-purple-brand p-12 md:p-16 shadow-2xl text-center">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              <span className="text-2xl font-bold dark:text-white">POR:</span>
              <span className="text-6xl md:text-8xl font-black text-wine dark:text-white">R$ 67,20</span>
            </div>
            <p className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-10">OU <span className="text-purple-brand">10X DE R$ 8,08</span></p>
            <div className="text-left max-w-md mx-auto space-y-4 mb-12">
              <div className="flex items-center gap-3">
                ...
                <span className="dark:text-gray-200">Acesso completo ao Meu Luuk</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="material-icons-outlined text-primary bg-primary/10 rounded-full p-1">check</span>
                <span className="dark:text-gray-200">Experimente Antes de Comprar (IA)</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="material-icons-outlined text-primary bg-primary/10 rounded-full p-1">check</span>
                <span className="dark:text-gray-200">Armário Digital dentro do app Wardrobe</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="material-icons-outlined text-primary bg-primary/10 rounded-full p-1">check</span>
                <span className="dark:text-gray-200">Guia: Domine seu estilo em 7 dias</span>
              </div>
            </div>
            <a className="block w-full bg-primary text-wine font-black text-2xl py-6 rounded-2xl hover:scale-105 transition-transform shadow-xl mb-6" href="https://pay.kiwify.com.br/oCcX4pQ">
      ...
      <section className="py-24 bg-cover bg-center bg-no-repeat relative px-6" id="contact" style={{ backgroundImage: "url('/img/FOTO10 1.png')" }}>
        <div className="absolute inset-0 bg-wine/75 dark:bg-zinc-900/90 backdrop-blur-sm"></div>
        <div className="max-w-2xl mx-auto bg-white dark:bg-zinc-800 p-10 rounded-[40px] shadow-xl text-center border-2 border-primary/20 relative z-10">
          ...
          <a className="flex items-center justify-center gap-4 bg-[#29AF1C] text-white font-black text-3xl py-6 px-8 rounded-2xl hover:brightness-105 transition-all shadow-lg shadow-green-500/20 w-full" href="https://w.app/c0pekt" target="_blank" rel="noopener noreferrer">
      ...
      <footer className="bg-wine pt-20 pb-10 px-6 text-white">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <div className="flex gap-6 mb-12">
            <a className="w-12 h-12 rounded-full bg-wine-light flex items-center justify-center hover:bg-primary hover:text-wine transition-colors" href="#">
